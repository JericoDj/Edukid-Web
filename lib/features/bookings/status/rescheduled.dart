...
class RescheduledBookingsScreen extends StatelessWidget {
  const RescheduledBookingsScreen({Key? key}) : super(key: key);
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                if (bookings != null && bookings.isNotEmpty) {
                  final filteredBookings = bookings
                      .where((booking) => booking.status == OrderStatus.rescheduled)
                      .toList();
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Icon(Icons.refresh, color: MyColors.primaryColor),
                                      SizedBox(width: 8),
                                      Expanded(
                                        child: Text(
