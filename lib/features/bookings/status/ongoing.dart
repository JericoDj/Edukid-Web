...
class OngoingBookingsScreen extends StatelessWidget {
  const OngoingBookingsScreen({Key? key}) : super(key: key);
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            if (bookings != null && bookings.isNotEmpty) {
              final filteredBookings = bookings
                  .where((booking) => booking.status == OrderStatus.ongoing)
                  .toList();
