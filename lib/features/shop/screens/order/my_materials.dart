...
import 'view_material.dart';  // Make sure you have ViewMaterial imported

class MyMaterialsPage extends StatefulWidget {
  final bool isInteractive; // Add isInteractive as a parameter for MyMaterialsPage
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: selectedPdfUrl != null
        ...
        isInteractive: widget.isInteractive, // Pass isInteractive here
      )
